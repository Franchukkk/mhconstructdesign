...
@section('content')
  ...
  <section class="hero-block items-center" id="about">
    ...
    <div class="hero-block__content">
      ...
      execution — transforming <br> concepts into real, stunning spaces.</p>
  ...
  <section class="services" id="services">
    ...
    <div class="wrapper">
      ...
      <div class="service__description col-12 col-md-6">
        <p>Our custom-made cabinetry service offers a bespoke approach to home organization and design. From concept
        to installation, we work closely with you to ensure every detail is meticulously crafted to perfection.</p>
      </div>
      </div>
    </div>
    </div>
  ...
  <section class="how-we-work">
    ...
    <div class="row how-we-work__steps">
      ...
      <div class="step-card" data-img-src="{{ asset('images/step7.webp') }}">
        ...
        This allows you to see your future interior in detail, and gives contractors precise guidance for
        flawless execution.
        </p>
      </div>
      ...
      <div class="step-card" data-img-src="{{ asset('images/step10.webp') }}">
        ...
        <p>Before you move in, we take care of the final styling: furniture placement, decor accents, lighting
