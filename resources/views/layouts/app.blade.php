...
<head>
    ...
    "@type": "Organization",
    "name": "M&H Construction and Design",
    "url": "{{ url()->current() }}",
...
<body>
    <header class="header-line">
        <div class="wrapper flex-between items-center">
            ...
            <a href="javascript:void(0)" class="burger" id="burger" role="button" aria-controls="burgerMenu" aria-expanded="false">
                <span></span>
                <span></span>
                <span></span>
            </a>
    ...
    <div class="burger-menu" id="burgerMenu">
        <ul class="d-flex">
            ...
            <li><a href="{{ route('home') . "#services" }}">Services</a></li>
            <li><a href="{{ route('portfolio.index') }}">Portfolio</a></li>
            <li class="blog-list-item"><a href="{{ route('blog.index') }}">Blog</a></li>
        ...
        <div class="wrapper">
            <div class="footer-top-section flex-between items-center">
                ...
                <ul class="contacts">
                    ...
                    <li><a href="mailto:info@mhconstructdesign.com"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                                ...
                                <path
                                    ...
                                    stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>Write to us: info@mhconstructdesign.com</a></li>
                </ul>
                <ul class="sociality d-flex">
                    ...
                    <a class="lidin" href="#" aria-label="Connect on LinkedIn"></a>
                </ul>
            </div>
            <hr>
