    ...
    <section class="get-involved wrapper">
        <div class="row items-center g-5">
            ...
            <div class="col-12 col-md-8 col-lg-8">
                <img loading="lazy" src="{{ asset("images/get-involved-img.webp") }}" alt="Team of designers ready to turn your vision into reality — join the creative journey with M&H Construct and Design.">
            </div>
        </div>
    </section>
@endsection